...
// * {@link CoinFragment.OnFragmentInteractionListener} interface
...
public class CoinFragment extends Fragment {
    ...
    private void updateUI() {
        ...
        TextView mValue = rootView.findViewById(R.id.tvValue);
        TextView mChange1h = rootView.findViewById(R.id.tvChange1hr);
        TextView mChange24h = rootView.findViewById(R.id.tvChange24hr);
        TextView mChange7d = rootView.findViewById(R.id.tvChange7d);
        TextView mMarketcap = rootView.findViewById(R.id.tvMarketcapValue);
